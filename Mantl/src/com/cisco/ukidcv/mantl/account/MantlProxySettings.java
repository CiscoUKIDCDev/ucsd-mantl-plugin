 ...
 *
 */
public class MantlProxySettings {
	 ...
	 * instead obtain it from the MantlAccount
	 *
	 * @param account
	 *            Account to get it from
	 * @see com.cisco.ukidcv.mantl.account.MantlAccount
	 */
	public MantlProxySettings(MantlAccountJsonObject account) {
		if (account == null) {
			this.proxy = false;
	 ...
	 *
	 * @see com.cisco.ukidcv.mantl.account.MantlAccount#setProxy
	 *
	 */
	public MantlProxySettings() {
		this.proxy = false;
		this.proxyAuth = false;
	}
}
